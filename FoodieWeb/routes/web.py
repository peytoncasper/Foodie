...
api_key = "55fabc0e4cf9ce4a56827e5b4e3b22e2"
...
def upload():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if barcodeName is "null":
                barcodeName = "No Product Info Available"
            cassandra_helper.session.execute(updateSensor.bind({"sensor_id":uuid.UUID(sensor_id), "barcode": barcode["gtin"], "product_name": barcodeName}))

            return jsonify(results=[barcodeName, barcode["gtin"]])
